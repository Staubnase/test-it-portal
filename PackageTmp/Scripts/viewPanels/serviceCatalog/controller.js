...
define(function (require) {
    var tpl = require("text!viewPanels/serviceCatalog/view.html");
        ...
        build: function (vm, node, callback) {
            ...
            var scModel = kendo.observable({
                ...
                navs: new kendo.data.DataSource({   //setup the left nav data source
                    ...
                    transport: { read: { url: "/ServiceCatalog/GetServiceCatalogWithCatGroup", xhrFields: { withCredentials: true }, dataType: "json", cache: false } }
                }),
                ...
                favROs: new kendo.data.DataSource({ //setup fav RO data source
                    ...
                    transport: { read: { url: "/ServiceCatalog/GetFavoriteRequestOffering", xhrFields: { withCredentials: true }, dataType: "json", cache: false } }
                }),
                topROs: new kendo.data.DataSource({ //setup Top RO data source
                    ...
                    transport: { read: { url: "/ServiceCatalog/GetTopRequestOffering", xhrFields: { withCredentials: true }, dataType: "json", cache: false } }
                }),
                topKAs: new kendo.data.DataSource({ //setup the top KA data source
                    schema: {
                        model: { id: "ArticleId" }
                    },
                    transport: { read: { url: "/api/v3/Article/GetTopArticlesByPopularity", xhrFields: { withCredentials: true }, data: { count: 10 }, dataType: "json", cache: false } }
                }),
                ...
                showCatalog: function () {
                    ...
                    //This will open the catalog if SCId is present US-24330
                    var getSCId = app.getParameterByName("SCId");
                    if (getSCId != "") {
                        _.defer(function () {
                            $("span[data-service='" + getSCId + "']").click();
                        });
