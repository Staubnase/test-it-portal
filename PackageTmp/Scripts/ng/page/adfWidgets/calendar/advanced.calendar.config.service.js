...
(function () {
    ...
    define(['app'], function (ngApp) {
        ...
        ngApp.factory('AdvancedCalendarConfigService', ['$http', '$q', 'LocalizationService', 'notificationService', AdvancedCalendarConfigService]);

        function AdvancedCalendarConfigService($http, $q, localizationService, notificationService) {

            var CONFIG_FILE_BASE_URL = '/Scripts/ng/page/adfWidgets/calendar/configFiles/';
