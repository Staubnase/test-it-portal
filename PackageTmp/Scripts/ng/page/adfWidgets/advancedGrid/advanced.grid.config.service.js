...
(function () {
    ...
    define(['app'], function (ngApp) {
        ...
        ngApp.factory('AdvancedGridConfigService', ['$http', '$q', 'LocalizationService', 'notificationService', AdvancedGridConfigService]);

        function AdvancedGridConfigService($http, $q, localizationService, notificationService) {

            var CONFIG_FILE_BASE_URL = '/Scripts/ng/page/adfWidgets/advancedGrid/configFiles/';
